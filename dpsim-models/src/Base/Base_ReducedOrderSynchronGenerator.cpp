...
Base::ReducedOrderSynchronGenerator<Real>::ReducedOrderSynchronGenerator(
	...
	mH(mAttributes->create<Real>("H")),
	mLd(mAttributes->create<Real>("Ld")),
	mLq(mAttributes->create<Real>("Lq")),
	mL0(mAttributes->create<Real>("L0")),
	mLd_t(mAttributes->create<Real>("Ld_t")),
	mLq_t(mAttributes->create<Real>("Lq_t")),
	mLd_s(mAttributes->create<Real>("Ld_s")),
	mLq_s(mAttributes->create<Real>("Lq_s")),
	mTd0_t(mAttributes->create<Real>("Td0_t")),
	mTq0_t(mAttributes->create<Real>("Tq0_t")),
	mTd0_s(mAttributes->create<Real>("Td0_s")),
